export default function IndexPage() {
  return (
    <div>
      <div className="cursor-pointer text-lg font-futura w-full flex mx-auto justify-center text-center items-center h-8 bg-th-background text-primary-dark">
        <div className="cursor-pointer text-lg font-futura w-full flex mx-auto justify-center text-center items-center h-8 bg-th-accent-light text-white ">
          <div className="border px-6 mt-0.5 mb-0.5 -pt-1 -pb-10 animate-pulse flex  rounded-full">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
              ...
              fillRule="evenodd"
              clipRule="evenodd"
              className="mr-1  translate-y-1.5"
              fill="white"
            >
            ...
            <p className="translate-y-0.5">ANTHROPOS TOKEN DROP NOW LIVE!</p>
          </div>
        </div>
      </div>
    </div>
